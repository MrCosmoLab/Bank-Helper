...
Такие блокировки это нормально, поскольку в архиве и установщике содержится необходимый для работы программы «SampFuncs» (взятый с официального ресурса), на который могут жаловаться браузеры.
____
